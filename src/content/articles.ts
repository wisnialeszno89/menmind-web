...
export const articles: ArticlePreview[] = [
  ...
  { slug:"praca-mnie-niszczy-psychicznie", title:"Praca mnie niszczy psychicznie", intro:"Gdy praca zaczyna wpływać na zdrowie psychiczne.", world:"kryzys" },
  { slug:"praca-nie-daje-mi-satysfakcji", title:"Praca nie daje satysfakcji", intro:"Dlaczego praca przestaje cieszyć.", world:"kryzys" },
  { slug:"stoje-w-miejscu-w-pracy", title:"Stoję w miejscu w pracy", intro:"Jak wyjść ze stagnacji zawodowej.", world:"kryzys" },
  { slug:"czy-warto-zmienic-branze-po-30", title:"Czy warto zmienić branżę po 30", intro:"Zmiana zawodowa po trzydziestce.", world:"wzrost" },
  { slug:"jak-znalezc-lepsza-prace", title:"Jak znaleźć lepszą pracę", intro:"Praktyczne kroki zmiany pracy.", world:"wzrost" },
  { slug:"stagnacja-w-pracy-mezczyzna", title:"Stagnacja w pracy mężczyzny", intro:"Gdy rozwój zatrzymuje się.", world:"kryzys" },
  { slug:"presja-utrzymania-rodziny", title:"Presja utrzymania rodziny", intro:"Jak radzić sobie z odpowiedzialnością finansową.", world:"kryzys" },
