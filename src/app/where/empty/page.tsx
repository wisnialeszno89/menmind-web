...
export default function WhereEmptyPL() {
  return (
    <main className="min-h-screen px-6 py-16">
      <div className="mx-auto max-w-3xl">
        <header className="mb-8">
          <p className="text-sm text-zinc-400">MenMind · wypalenie</p>
          <h1 className="mt-3 text-4xl font-semibold tracking-tight">
            Czuję pustkę i wypalenie
          </h1>
          <p className="mt-4 text-zinc-300 leading-relaxed">
            Nie naprawiamy sensu życia. Przywracamy energię i kontakt z rzeczywistością.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-zinc-800/70 bg-zinc-900/40 p-6 shadow-lg shadow-black/20 backdrop-blur">
          ...
          <ul className="mt-4 space-y-3 text-zinc-300 leading-relaxed">
            <li><span className="text-cyan-200 font-medium">•</span> 10 minut ruchu (bez ambicji).</li>
            <li><span className="text-cyan-200 font-medium">•</span> Wyłącz 1 bodziec, który Cię mieli.</li>
            <li><span className="text-cyan-200 font-medium">•</span> Jedzenie + woda + prysznic = fundament.</li>
          </ul>
          ...
          <div className="mt-10">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Link href="/spec/trening" className="rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-4 hover:bg-zinc-900/50 transition">
                <p className="text-sm text-zinc-400">Lekko</p>
                <p className="mt-1 font-semibold text-zinc-100">Ruch / trening</p>
                <p className="mt-2 text-sm text-zinc-400">Minimum wysiłku, maksimum efektu.</p>
              ...
              <Link href="/spec/grupy" className="rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-4 hover:bg-zinc-900/50 transition">
                ...
                <p className="mt-1 font-semibold text-zinc-100">Grupy / ludzie</p>
                <p className="mt-2 text-sm text-zinc-400">Izolacja karmi pustkę.</p>
                <p className="mt-3 text-sm text-cyan-200">Zobacz →</p>
              </Link>

              <Link href="/navimind?state=empty" className="rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-4 hover:bg-zinc-900/50 transition sm:col-span-2">
                <p className="text-sm text-zinc-400">Rozmowa</p>
                <p className="mt-1 font-semibold text-zinc-100">Navimind</p>
                <p className="mt-2 text-sm text-zinc-400">Gdy czujesz, że nie ma sensu — ustawiamy tor od zera.</p>
