...
const questions = [
  ...
  "Czuję się psychicznie wyczerpany",
  "Trudno mi zacząć dzień",
  "Nie cieszą mnie rzeczy które kiedyś cieszyły",
  "Czuję że jestem przeciążony"
]
    ...
    return(
      <main className="min-h-screen bg-white">
        <div className="max-w-xl mx-auto px-6 py-24">
          ...
          <RecommendedPath
            title="Ścieżka kryzys"
            description="Zatrzymaj przeciążenie i wróć do podstaw."
            href="/sciezki/kryzys"
          />

          <TestNextSteps
            pathHref="/sciezki/kryzys"
