        ...
        <section className="mt-8 rounded-2xl border border-zinc-800/70 bg-zinc-900/40 p-6 shadow-lg shadow-black/20 backdrop-blur">
          ...
          {!action ? (
            ...
            <div className="mt-6 rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-6">
              ...
              <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
                If it’s a good fit, we’ll reach out by email. Usually within 24–72 hours.
              </p>
            ...
            >
              ...
              {/* Meta */}
              <input type="hidden" name="source" value="menmind.app/partnership (EN)" />
              ...
              <div className="rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-4">
                ...
                <p className="mt-1 text-xs text-zinc-500">
                  You can add a PDF/offer/price list (if your form provider supports it).
                </p>
              ...
              <p className="mt-3 text-xs text-zinc-500">
                ...
                We review manually and publish only verified value.
              </p>
            </form>
          )}
        </section>
    ...
    <label className="block">
      ...
      {textarea ? (
        ...
        <input
          ...
          required={required}
          placeholder={placeholder}
          className="mt-2 w-full rounded-xl border border-zinc-800/70 bg-zinc-950/30 px-4 py-3 text-sm text-zinc-200 placeholder:text-zinc-500 outline-none focus:ring--cyan-500/20"
        />
      )}
    </label>
  );
