      ...
      <div className="mx-auto max-w-3xl">
        <header className="mb-8">
          ...
          <p className="mt-4 text-zinc-300 leading-relaxed">
            This direction is for moments when your mind loops and your body
            needs a reset. Movement calms the nervous system faster than
            overthinking.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-zinc-800/70 bg-zinc-900/40 p-6 shadow-lg shadow-black/20 backdrop-blur">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {CITIES_EN.map((c) => {
              ...
              return (
                <Link
                  key={c.key}
                  href={`/en/spec/training?city=${c.key}`}
                  className={[
          ...
          <div className="mt-8 rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-5">
            ...
            <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
              Soon: gyms, trainers, martial arts, group training and simple
          ...
          <div className="mt-8">
            <Link
              href={`/en/suggestions?state=pressure&city=${city}`}
...
export default function TrainingPageEN(props: { searchParams?: { city?: string } }) {
  return (
    <Suspense>
      <Content {...props} />
    </Suspense>
