      ...
      <div className="mx-auto max-w-3xl">
        <header className="mb-8">
          ...
          <p className="mt-4 text-zinc-300 leading-relaxed">
            This direction is for clarity, stability and emotional support.
            No shame. No labels.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-zinc-800/70 bg-zinc-900/40 p-6 shadow-lg shadow-black/20 backdrop-blur">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {CITIES.map((c) => {
              ...
              return (
                <Link
                  key={c.key}
                  href={`/en/spec/psychologists?city=${c.key}`}
                  className={[
          ...
          <div className="mt-8 rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-5">
            ...
            <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
              We’re building quality first. Soon: city filters + online options.
            </p>
            ...
            <p className="mt-5 text-xs text-zinc-500">
              Next: verification rules + no spam.
            </p>
          </div>
...
export default function PsychologistsPageEN(props: { searchParams?: { city?: string } }) {
  return (
    <Suspense>
      <Content {...props} />
    </Suspense>
