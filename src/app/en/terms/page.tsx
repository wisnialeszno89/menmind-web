  ...
  return (
    <main className="min-h-screen px-6 py-16">
      <div className="mx-auto max-w-3xl">
        <p className="text-sm text-zinc-400">Waypoint · document</p>
        ...
        <p className="mt-4 text-zinc-300 leading-relaxed">
          Waypoint is a simple waypoint and a set of supportive tools for difficult moments.
          By using the website you accept the terms below.
        </p>

        <section className="mt-10 space-y-6 text-zinc-300 leading-relaxed">
          <div>
            <h2 className="text-lg font-semibold text-zinc-100">1. What Waypoint is</h2>
            <p className="mt-2">
              Waypoint is not a medical, psychological, or therapeutic service.
          ...
          <div>
            ...
            <p className="mt-2">
              You use Waypoint voluntarily and at your own risk.
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              contact your local emergency number. Waypoint is not an emergency service.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Waypoint does not require an account. Some features may rely on third-party services
          ...
          <div>
            ...
            <p className="mt-2">
              Waypoint may include links to external resources and partner offers.
