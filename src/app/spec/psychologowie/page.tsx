        ...
        <section className="rounded-2xl border border-zinc-800/70 bg-zinc-900/40 p-6 shadow-lg shadow-black/20 backdrop-blur">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {CITIES_PL.map((c) => {
              ...
              return (
                <Link
                  key={c.key}
                  href={`/spec/psychologowie?city=${c.key}`}
                  className={[
          ...
          <div className="mt-8 rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-5">
            ...
            <p className="mt-5 text-xs text-zinc-500">
              Docelowo: lista wg miasta + online + zasady weryfikacji.
            </p>
          </div>
...
export default function PsychologowiePage(props: { searchParams?: { city?: string } }) {
  return (
    <Suspense>
      <Content {...props} />
    </Suspense>
